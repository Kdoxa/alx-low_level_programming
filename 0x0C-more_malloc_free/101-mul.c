 ...
 *
 * Description: If there is insufficient space, the functuin exists with a status of 98.
...
/**
 * iterate_zeroes - Iterates through a string of numbers containing leading zeroes until it hits a non zero no
